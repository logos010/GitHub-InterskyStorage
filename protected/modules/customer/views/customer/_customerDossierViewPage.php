...
<table class="display stylized" id="dossierList">
    ...
    <tbody>
        <?php $row = 1; foreach ($dossiers as $key => $value): ?>
            <tr class="<?php echo ($key % 2) ? 'even' : 'odd' ?>  gradeA">
                <td width="100"><?php echo $value->dossier_id ?></td>
                <td width="120"><?php echo $value->barcode == null ? 'NULL' : $value->barcode ?></td>
                <td><?php echo $value->dossier_name ?></td>
                <td width="100">
                    <?php
                        $distributes = $value->storage_distribute;
                        $locationCode = null;
                ...
                <td width="80">
                    <a href="javascript:void(0)" class="view-dossier-log" id="<?php echo $value->dossier_id ?>">View Log</a>
                </td>
            </tr>
        <?php  $row++; endforeach; ?>
    </tbody>
