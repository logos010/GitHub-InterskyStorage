...
<div class="clear"></div>
<table class="display stylized" id="containList">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr class="<?php echo ($key % 2) ? 'even' : 'odd' ?>  gradeA">
            ...
            <td><?php $this->widget('application.modules.storage.components.ContainFloorWidget', array('cid' => $value->contain_id, 'rid' => $value->range_id)); ?></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    <tfoot>
