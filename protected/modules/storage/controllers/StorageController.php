	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Storage']))
		{
			$model->attributes=$_POST['Storage'];
                        ...
                        $file = CUploadedFile::getInstance($model, 'map');
                        $model->map = $file->getName();
                        
                        
                        $contactName = $_POST['contact']['name'];
                        $contactPhone = $_POST['contact']['phone'];
                        
                        $json = array('name' => $contactName, 'phone' => $contactPhone);
                        $model->contact_peolpe = CJSON::encode($json);
                        
			if($model->save()){                            
                            $file->saveAs(Yii::app()->baseUrl."/uploads/storage/map/".$file->getName());
                            $this->refresh();                            
                        }
		}
